...
#define ASH_REGISTER(...) \
template <> const char* ::ash::detail::dynamic_class_descriptor< __VA_ARGS__ >::class_name = ::ash::registry::dynamic_object_factory::get().register_class< __VA_ARGS__ >(#__VA_ARGS__)

/// Register a dynamic class into the class factories under a custom name.
#define ASH_REGISTER_WITH_NAME(NAME, ...) \
template <> const char* ::ash::detail::dynamic_class_descriptor< __VA_ARGS__ >::class_name = ::ash::registry::dynamic_object_factory::get().register_class< __VA_ARGS__ >(NAME)
