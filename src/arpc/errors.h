...
#ifndef ARPC_ERRORS_H_
#define ARPC_ERRORS_H_
...
#define ERROR_CLASS(NAME)                                                    \
  ...
  inline std::string_view                                                    \
      arpc::errors::detail::error_class_descriptor<NAME>::error_class_name = \
          ::arpc::error_factory::get().register_error_class<NAME>(#NAME);    \
                                                                             \
  class NAME : public ::arpc::errors::base_error {                           \
   public:                                                                   \
    using ::arpc::errors::base_error::base_error;                            \
                                                                             \
   private:                                                                  \
...
class error_factory : public singleton<error_factory> {
 ...
 private:
  arpc::flat_map<std::string_view, error_function_type> error_function_map_;
};
