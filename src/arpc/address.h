...
#ifndef ARPC_ADDRESS_H_
#define ARPC_ADDRESS_H_
...
static_assert(
    ...
    "arpc::address has to remain data-compatible with struct addrinfo");

}  // namespace arpc

namespace std {
template <>
struct iterator_traits<::arpc::address_list::iterator> {
  using value_type = ::arpc::address;
  using difference_type = std::ptrdiff_t;
  using pointer = value_type*;
  using reference = value_type&;
...
template <>
struct iterator_traits<::arpc::address_list::const_iterator> {
  using value_type = const ::arpc::address;
  using difference_type = std::ptrdiff_t;
