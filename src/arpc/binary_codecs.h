...
#ifndef ARPC_BINARY_CODECS_H_
#define ARPC_BINARY_CODECS_H_
...
class binary_encoder {
 ...
 private:
  ...
  void save_dynamic_object_reference(const ::arpc::dynamic_base_class& o) {
  ...
  // speed.
  arpc::flat_map<std::string_view, seen_class_info> class_info_map_;
