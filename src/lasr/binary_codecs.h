...
class binary_encoder {
 ...
 private:
  ...
  void save_dynamic_object_reference(const ::lasr::dynamic_base_class& o) {
  ...
  // speed.
  lasr::flat_map<std::string_view, seen_class_info> class_info_map_;
  lasr::flat_map<const void*, std::size_t> shared_object_map_ = {{nullptr, 0}};
