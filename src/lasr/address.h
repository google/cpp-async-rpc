...
namespace std {
template <>
struct iterator_traits<::lasr::address_list::iterator> {
  using value_type = ::lasr::address;
  using difference_type = std::ptrdiff_t;
  using pointer = value_type*;
  using reference = value_type&;
...
template <>
struct iterator_traits<::lasr::address_list::const_iterator> {
  using value_type = const ::lasr::address;
  using difference_type = std::ptrdiff_t;
