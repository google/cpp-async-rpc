...
#define LASR_INT_SEQ_TYPE_UNARY_OP(NAME, OP)    \
  struct NAME : unary_op<::lasr::mpt::NAME> {}; \
...
/// elements)
/// in any of the sequence types supported by `lasr::mpt`.
