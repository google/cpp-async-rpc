...
template<typename T, typename Seen = mpt::pack<>, std::uint32_t base =
		2166136261, typename Enable = void>
struct type_hash;
...
struct compose_with_types<base, Seen, T, TN...> {
	static constexpr std::uint32_t value = compose_with_types<
			type_hash<T, Seen, base>::value, Seen, TN...>::value;
};
...
struct type_hash<T, Seen, base,
	...
	static constexpr std::uint32_t value = detail::compose_with_types<
			detail::type_hash_add(base, detail::type_family::ARRAY, false,
					std::extent < T > ::value), mpt::insert_into_t<T, Seen>,
...
struct type_hash<std::tuple<T...>, Seen, base,
	...
	static constexpr std::uint32_t value = detail::compose_with_types<
			detail::type_hash_add(base, detail::type_family::TUPLE, false,
					sizeof...(T)), mpt::insert_into_t<std::tuple<T...>, Seen>,
	T...>::value;
};
...
struct type_hash<T, Seen, base,
	...
	static constexpr std::uint32_t value = detail::compose_with_types<
			detail::type_hash_add(base, detail::type_family::ARRAY, false,
					std::tuple_size < T > ::value), mpt::insert_into_t<T, Seen>,
	...
	static constexpr std::uint32_t value =
			detail::compose_with_types<
					detail::type_hash_add(base, detail::type_family::SEQUENCE,
							false, 0), mpt::insert_into_t<T, Seen>,
...
struct type_hash<std::unique_ptr<T, Deleter>, Seen, base,
	...
	static constexpr std::uint32_t value =
			detail::compose_with_types<
					detail::type_hash_add(base, detail::type_family::UNIQUE_PTR,
							false, 0),
...
struct type_hash<std::shared_ptr<T>, Seen, base,
	...
	static constexpr std::uint32_t value = detail::compose_with_types<
			detail::type_hash_add(base, detail::type_family::SHARED_PTR, false,
					0), mpt::insert_into_t<std::shared_ptr<T>, Seen>, T>::value;
};
...
struct type_hash<std::weak_ptr<T>, Seen, base,
	...
	static constexpr std::uint32_t value = detail::compose_with_types<
			detail::type_hash_add(base, detail::type_family::WEAK_PTR, false,
					0), mpt::insert_into_t<std::weak_ptr<T>, Seen>, T>::value;
};

template<typename C, typename T, T C::*m_ptr, typename Seen, std::uint32_t base>
...
struct type_hash<T, Seen, base,
		typename std::enable_if<
				can_be_serialized<T>::value && !mpt::is_in<T, Seen>::value>::type> {
private:
	...
	static constexpr std::uint32_t with_fields =
			detail::compose_with_types<
					detail::type_hash_add(with_base_classes,
							detail::type_family::FIELD, false,
							mpt::size<typename get_field_descriptors<T>::type>::value),
					mpt::insert_into_t<T, Seen>,
