#ifndef INCLUDE_ASH_INTERFACES_H_
#define INCLUDE_ASH_INTERFACES_H_
...
#define ASH_EXPORT(NAME)                                               \
  ::ash::interfaces::MethodDescriptor<decltype(&self_interface::NAME), \
                                      &self_interface::NAME>
#define ASH_EXTEND(BASE) BASE::interface_descriptor
#define ASH_INTERFACE(CLS, ...) \
  using self_interface = CLS;   \
  using interface_descriptor =  \
      ::ash::interfaces::InterfaceDescriptor<CLS, __VA_ARGS__>
...
#endif  // INCLUDE_ASH_INTERFACES_H_
